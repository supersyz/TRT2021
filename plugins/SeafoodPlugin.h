...
class SeafoodPlugin: public nvinfer1::IPluginV2IOExt {
public:
    SeafoodPlugin(nvinfer1::Weights valueToAdd) {
        m.valueToAdd = *(float *)valueToAdd.values;
    }
    SeafoodPlugin() {
    }
    
    SeafoodPlugin(const void *buffer, size_t length) {
    ...
    nvinfer1::IPluginV2IOExt* clone() const override {
        return new SeafoodPlugin(&m, sizeof(m));
    }
    ...
    const char* getPluginType() const override {return "SeafoodPlugin";}
...
class SeafoodPluginCreator : public nvinfer1::IPluginCreator {
public:
    nvinfer1::IPluginV2* deserializePlugin(const char* name, const void* serialData, size_t serialLength) override {
        return new SeafoodPlugin(serialData, serialLength);
    }
    
    const char* getPluginName() const override {return "SeafoodPlugin";}
    const char* getPluginVersion() const override {return "0";}
    ...
    nvinfer1::IPluginV2* createPlugin(const char* name, const nvinfer1::PluginFieldCollection* fc) override {
        ...
        return new SeafoodPlugin({nvinfer1::DataType::kFLOAT, &valueToAdd, 1});
    }
};
